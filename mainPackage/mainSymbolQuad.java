...
public class mainSymbolQuad {
    ...
    // Create the tables
       ...
       System.out.println("The KIND for slot 5 is "+symbols.GetKind(5)+", data type is "+ symbols.GetDataType(5)+" and the value: "+symbols.GetString(5));
       index = symbols.LookupSymbol("BadVal");
       System.out.println("BadVal search returned "+index+'\n');
       symbols.print("symtable.txt");
